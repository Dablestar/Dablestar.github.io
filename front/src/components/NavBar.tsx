        ...
        <div className={"sidebar w-1/12 flex flex-col bg-[#b8b8b8] p-5 min-h-screen fixed transition-all duration-300 ease-in-out hover:w-2/12"} onMouseEnter={() => {setNavHover(true); setIsHover(true);}} onMouseLeave={() => {setNavHover(false); setIsHover(false);}}>
                ...
                <nav className="flex flex-grow flex-col">
                    <ul className="!mt-15 font-thin">
                        ...
                        <li className="h-15 transition-colors duration-1000 ease-in-out hover:bg-[#242424] text-gray-800 hover:text-white">
                            <Link to={"/"} className="h-full flex items-center justify-center">
                            <div className="icon flex-shrink-0 w-7 h-7 transition-colors duration-1000 ease-in-out">
                        ...
                        <li className="h-15 transition-colors duration-1000 ease-in-out hover:bg-[#242424] text-gray-800 hover:text-white">
                            <Link to={"/threads"} className="h-full flex items-center justify-center">
                                ...
                                <span className={`whitespace-nowrap overflow-hidden transition-all duration-300 ease-in-out ${isHover ? "opacity-100 max-w-40 ml-3" : "opacity-0 max-w-0"}`}>Threads</span>
                            </Link>
                        </li>
                    </ul>
                </nav>
