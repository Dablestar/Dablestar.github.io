...
function Footer(){
    return (
        <footer className="footer bg-[#242424] w-full h-2/12 flex flex-row text-white justify-between">
            <p className="copyrightText text-2xl">© Copyright by Daburu 2025 All rights reserved.</p>
