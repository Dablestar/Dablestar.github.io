...
function Footer(){
    return (
        <footer className="footer bg-[#242424] w-10/12 h-25 flex flex-row text-white justify-between fixed bottom-0 right-0 items-center p-5">
            <p className="copyrightText text-2xl !ml-20">© Copyright by Daburu 2025 All rights reserved.</p>
            <div className="sns flex flex-row gap-4">
